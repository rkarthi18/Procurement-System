...
<body>
	...
	<div class="container-fluid"
		...
		<form action="ProcurementEmployeeMakeOrder" method="POST">
				...
				<div
					...
					<div class="form-group row"
						...
						<div class="col-8">
							...
							</select> <input name="requestId" value="<%=requestMade.getRequestId()%>"
								hidden> <input name="itemId"
								value="<%=item.getItemId()%>" hidden> <input
								name="username" value="<%=employee.getUsername()%>" hidden>
						</div>
					...
					<div class="form-group row"
						style="padding: 4px; padding-left: 16px">
						<label class="col-4 col-form-label" for="EmpForm01BasicDetails02">Unit
							Price: *</label>
						<div class="col-8">
							<input type="number" value="<%=unitPrice%>" class="form-control"
								id="price" required="required" name="price" readonly>
						</div>
					</div>

					<div class="form-group row"
						style="padding: 4px; padding-left: 16px">
						<label class="col-4 col-form-label" for="EmpForm01BasicDetails02">Total
							Amount : *</label>
						<div class="col-8">
							<input type="number" value="<%=total%>" class="form-control"
								id="total" required="required" name="total" readonly>
						</div>
					</div>
					...
					<div class="form-group row"
						...
						<div class="col-8">
							<input type="text" class="form-control" id="email"
								required="required" name="email" value="<%=email%>" readonly>
						</div>
					</div>
			...
			<div
				style="clear: both; float: left; margin-top: 20px; margin-left: 600px">
				<div class="form-group row">
					<div>
