	...
	<header class="page-header" id="header01">
		...
		<div class="container-fluid" style="margin-top: 10px;">
			<ul class="nav nav-pills  nav-justified nav-header">
				...
				<li class="nav-item" title="Click to See Your Duties"><a
					class="nav-link nav-change" href="SiteManager_Home.jsp"
					role="button" aria-haspopup="true" aria-expanded="false"
					style="border-radius: 15px; text-align: center; background-color: white; color: #111E6C">Policies</a>
				</li>

				<li class="nav-item " title="Click to See Your Duties"><a
					class="nav-link nav-change" href="SiteManager_Inventory.jsp"
					role="button" aria-haspopup="true" aria-expanded="false"
					style="border-radius: 15px; text-align: center; background-color: white; color: #111E6C">Site
						Inventory</a></li>
				<li class="nav-item " title="Click to See Your Duties"><a
					class="nav-link nav-change" href="SiteManager_RequestOrder.jsp"
					role="button" aria-haspopup="true" aria-expanded="false"
					style="border-radius: 15px; text-align: center; background-color: white; color: #111E6C">Request
						Orders</a></li>
				<li class="nav-item " title="Click to See Your Duties"><a
					class="nav-link nav-change" href="SiteManager_RequestHistory.jsp"
					role="button" aria-haspopup="true" aria-expanded="false"
					style="border-radius: 15px; text-align: center; background-color: white; color: #111E6C">Request
						History</a></li>
				<li class="nav-item " title="Click to See Your Duties"><a
					class="nav-link nav-change" href="SiteManager_PendingDelivery.jsp"
					role="button" aria-haspopup="true" aria-expanded="false"
				...
				<div style="float: left; margin-right: 5px;">
					<div
						...
						<input name="employeeId" id="employeeId"
							value="<%=employee.getEmployeeId()%>" hidden> <input
							name="username" id="username" value="<%=employee.getUsername()%>"
							hidden>
						<h5>Basic Details</h5>
							...
							<div class="col-8">
								<div class="form-group">
									<label for="EmpForm01ContactDetails01">Line 01: *</label> <input
										...
										value="<%=employee.getAddressStreet1() %>">
								</div>
								<div class="form-group">
									<label for="EmpForm01ContactDetails02">Line 02: *</label> <input
										...
										name="addressStreet2"
										value="<%=employee.getAddressStreet2() %>">
								</div>
							</div>
						</div>
						<div class="form-group row"
